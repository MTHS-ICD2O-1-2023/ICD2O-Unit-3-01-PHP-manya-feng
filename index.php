      ...
      <div class="page-content-php">
        <form action="answer.php" method="POST">
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type=" text" pattern="-?[0-9]*(\.[0-9]+)?" name="basea-of-trapezoid">
            <label class="mdl-textfield__label" for="base-of-triangle">Base a of trapezoid (mm)</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
          <br />
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type=" text" pattern="-?[0-9]*(\.[0-9]+)?" name="baseb-of-trapezoid">
            <label class="mdl-textfield__label" for="height-of-rectangle">Base b of trapezoid (mm)</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
          <br />
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type=" text" pattern="-?[0-9]*(\.[0-9]+)?" name="height-of-trapezoid">
            <label class="mdl-textfield__label" for="height-of-rectangle">Height of trapezoid (mm)</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
